    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Freshmen Vote <sup>by SSC</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <!-- <a class="nav-link collapsed" href="#" ><i class="fas fa-shopping-cart"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">ผู้เข้าประกวด Missile 2021</h1>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <?php
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM missile");
                                    $stmt->execute();
                    ...
                    <?php require 'viewmissileModal.php' ?>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Science Student 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
